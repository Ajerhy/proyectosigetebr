...
$(document).ready( function(){
	...
	jQuery.extend( $.fn.dataTable.defaults, {
		fixedHeader: true,
		dom:'<"row margin-bottom-12"' +
			'<"col-sm-12"' +
			'<"pull-left"l>' +
			'<"pull-right margin-left-10"B>' +
			'<"pull-right"fr>' +
			'>' +
			'>tip',
        buttons: [
            {
                extend: 'collection',
                text: '<i class="fa fa-list" aria-hidden="true"></i> &nbsp;' + 'Accion' ,
                className: 'btn-info',
                ...
                buttons: [
	                ...
	                {
		                extend: 'csv',
		                text: '<i class="fa fa-file-text-o" aria-hidden="true"></i> '+ 'export_to_csv',
		                className:'bg-info',
		                exportOptions: {
		                    columns: ':visible'
		                },
	                ...
	                {
		                extend: 'excel',
		                text: '<i class="fa fa-file-excel-o" aria-hidden="true"></i> '+ 'export_to_excel',
		                className:'bg-info',
		                exportOptions: {
		                    columns: ':visible'
		                },
	                ...
	                {
		                extend: 'pdf',
		                text: '<i class="fa fa-file-pdf-o" aria-hidden="true"></i> ' + 'export_to_pdf',
		                className:'bg-info',
		                exportOptions: {
		                    columns: ':visible'
		                },
		            ...
		            {
		                extend: 'colvis',
		                text: '<i class="fa fa-columns" aria-hidden="true"></i> '+ 'col_vis',
		                className:'bg-info',
		            },
                ]
        	}
